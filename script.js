...
// Twinkling Universe Effect for Probability Section
const probabilitySection = document.getElementById('probability');

function createUniverse() {
    if (!probabilitySection) return;

    // Clear existing
    const existingStars = probabilitySection.querySelectorAll('.star');
    ...
    for (let i = 0; i < 100; i++) {
        ...
        probabilitySection.appendChild(star);
    }
}
